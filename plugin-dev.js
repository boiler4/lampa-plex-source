(function () {
    ...
    function plexAuthHeaders() {
        ...
        return {
            ...
            'X-Plex-Version': '0.2.31-beta-dev',
    ...
    function transcodeProfileParams(profile) {
        var profiles = {
            ios_compat: { directPlay: '0', directStream: '1', videoCodec: 'h264', audioCodec: 'aac', protocol: 'hls', maxVideoBitrate: '12000' },
