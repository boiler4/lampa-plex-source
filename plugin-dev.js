(function () {
    ...
    function plexAuthHeaders() {
        ...
        return {
            ...
            'X-Plex-Version': '0.2.61-beta-dev',
    ...
    function addSettings() {
        ...
        add({ type: 'static', name: component + '_version', field: { name: 'Plugin version', description: '0.2.61-beta-dev' } });
    ...
    function start() {
        ...
        noty(t('loaded'));
        log('ready', { version: '0.2.61-beta-dev' });
    }
