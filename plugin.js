(function () {
    ...
    var I18N = {
            "ru": {
                    ...
                    "selectServerHelp": "Выбирайте local/direct, если доступно: обычно быстрее и лучше работает дома. Remote/relay полезно вне дома, но может быть медленнее.",
            ...
            "uk": {
                    ...
                    "selectServerHelp": "Вибирайте local/direct, якщо доступно: зазвичай швидше і краще працює вдома. Remote/relay корисно поза домом, але може бути повільніше.",
            ...
            "be": {
                    ...
                    "selectServerHelp": "Выбірайце local/direct, калі даступна: звычайна хутчэй і лепш працуе дома. Remote/relay карысна па-за домам, але можа быць павольней.",
            ...
            "zh": {
                    ...
                    "selectServerHelp": "如果可用，选择 local/direct：通常更快，适合家中使用。Remote/relay 适合外出访问，但可能更慢。",
            ...
            "pt": {
                    ...
                    "selectServerHelp": "Escolha local/direct quando disponível: geralmente é mais rápido e melhor em casa. Remote/relay é útil fora de casa, mas pode ser mais lento.",
            ...
            "bg": {
                    ...
                    "selectServerHelp": "Изберете local/direct, когато е налично: обикновено е по-бързо и работи най-добре вкъщи. Remote/relay е полезно извън дома, но може да е по-бавно.",
            ...
            "he": {
                    ...
                    "selectServerHelp": "בחר local/direct כשאפשר: לרוב מהיר יותר ומתאים לבית. Remote/relay שימושי מחוץ לבית אך עלול להיות איטי יותר.",
            ...
            "cs": {
                    ...
                    "selectServerHelp": "Vyberte local/direct, pokud je dostupné: obvykle je rychlejší a nejlepší doma. Remote/relay je užitečné mimo domov, ale může být pomalejší.",
            ...
            "ro": {
                    ...
                    "selectServerHelp": "Alege local/direct când este disponibil: de obicei e mai rapid și merge cel mai bine acasă. Remote/relay e util în afara casei, dar poate fi mai lent.",
            ...
            "fr": {
                    ...
                    "selectServerHelp": "Choisissez local/direct si disponible : c’est généralement plus rapide et idéal à la maison. Remote/relay est utile hors domicile mais peut être plus lent.",
